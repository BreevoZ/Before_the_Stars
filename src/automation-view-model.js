...
export function buildAutomationViewModel(session, { mobile = false } = {}) {
  ...
  put('talent-guide', !p.talents.spark ? '从根节点点亮第一颗星。花 1 Legacy 点亮文明火种，解锁 2× 速度。自动招募在累计通关 2 次后免费获得。' : mobile ? '上下探索时代，左右浏览侧枝 · 点击节点查看与购买' : '微光指引可购买的天赋 · 悬停或点击查看，双击购买 · 方向键探索星图');
