...
import { cloneRecord, fromSaveRecord, fromV8Record, fromV9Record, fromV10Record, fromV11Record, fromV12Record, fromV13Record, fromV14Record, fromV15Record, fromV16Record, fromV17Record, fromV18Record, fromV19Record } from '../src/save-record.js';
...
export function registerArchitectureTests(test, assert) {
  ...
  test('Save schema: each V1–V7 migration is deterministic and does not mutate or share mutable source data', () => {
    ...
    for (let version = 1; version < SAVE_VERSION; version++) {
      const hydrate = { 8: fromV8Record, 9: fromV9Record, 10: fromV10Record, 11: fromV11Record, 12: fromV12Record, 13: fromV13Record, 14: fromV14Record, 15: fromV15Record, 16: fromV16Record, 17: fromV17Record, 18: fromV18Record, 19: fromV19Record }[version];
