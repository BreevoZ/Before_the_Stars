...
export const TALENTS = Object.freeze({
  ...
  fireControl: { name: '战术火控', branch: 'automation', costs: PRICES.fireControl, requires: { evolution: 1 },
    effects: ['手动释放大招', '可自动轰击敌军密集处；复苏之光用于受伤友军'] },
  campaign: { name: '连续征战', branch: 'automation', costs: PRICES.campaign, requires: { fireControl: 1 },
    effects: ['手动继续战役', '可在普通战役胜利后自动进入下一场；文明终局仍由你重建'] },
  extermination: { name: '赶尽杀绝', branch: 'automation', costs: PRICES.extermination, requires: { campaign: 1 },
    effects: ['击败未来敌军才完成文明', '摧毁任意时代敌方基地即完成本轮文明，正常结算遗产；不再追击下一时代'] },
  ...
  challenge: { name: '余烬远征', branch: 'legacy', costs: PRICES.challenge, requires: { conservation: 1 },
    effects: ['初生之地循环', `解锁十片余烬的选关；已通关关卡可重返，逐关开放，敌军逐步强化，通关遗产 ×${ECONOMY.challengeBase} 每深入一层，最多 ${CHALLENGE.maxLevel} 次深入`] },
