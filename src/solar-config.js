...
// industrial (facilities only), relay (the outer edge), dwarf (the Kuiper belt).
...
export const BODIES = Object.freeze([
  ...
  body('neptune', '海王星', 30, 9, 'relay', '#6f8fc0', '冰巨星，太阳系的最后一颗行星。深空中继让方舟在这里也能与火星保持联系。', { phase: 3.3 }),
  body('pluto', '冥王星', 39.5, 3.5, 'dwarf', '#c2ab8f', '柯伊伯带的矮行星，氮冰平原与冰山构成它明亮的「心」。再往外的奥尔特云，要留给下一个时代。', { phase: 5.9 }),
]);
