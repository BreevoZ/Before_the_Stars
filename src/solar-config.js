...
export const BODIES = Object.freeze([
  body('mercury', '水星', .39, 4, 'industrial', '#a79c8a', '离太阳最近的岩石。适合铺设太阳能阵列，为所有行星工业供能。'),
  body('venus', '金星', .72, 6.5, 'industrial', '#d8c38f', '浓厚的酸性大气。高空浮空城可以采集大气，远期可以改造。'),
...
// Screen layout: a tilted, logarithmically spaced orrery in a 1000×620 frame.
export const SYSTEM = Object.freeze({ cx: 500, cy: 314, tilt: .4, sun: 18 });
// Log spacing, eased so the inner planets get room away from the sun's glare.
export const orbitRadius = au => 58 + 110 * Math.log2(1 + au) ** .85;
