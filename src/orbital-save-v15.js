...
import { BODIES, ORBITAL_STRUCTURES as S, ORBITAL_RULES as R, POLICIES, INTERVENTIONS } from './orbital-history.js';
import { oldOrbitalRates as orbitalRates, createOldOrbitalState as createOrbitalState } from './orbital-history.js';
...
export function validateOldOrbital(session, version) {
