...
export const UNITS = Object.freeze({
  ...
  superSoldier: Object.freeze({ name: '超级士兵', age: 5, role: 'heavy', playerOnly: true, projectile: 'plasma', ignoreArmor: true, cost: 3000, trainTime: 12, health: 6000, damage: 320, meleeDamage: 440, meleeRange: 60, armor: 32, speed: 48, range: 340, baseRange: 540, attackInterval: 0.55, bounty: 600, experience: 800, lane: 'front', description: '独行精锐 · 全覆轻甲，320 能量穿甲点射 / 近身 440 激光匕首', attackDuration: 0.4, muzzleX: 35, muzzleY: -43, height: 68 }),
